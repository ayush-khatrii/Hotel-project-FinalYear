...
export default () => {
	...
	return (
		<>
			...
			{error && (
				<div className='bg-red-200 text-center  p-2 mb-4'>Error: {error}</div>
			)}
			<main className='w-full h-screen flex flex-col items-center justify-center lg:px-4 px-5 '>
				<div className='max-w-sm w-full  space-y-5'>
					...
					<button
						type='submit'
						className='w-full flex items-center justify-center gap-x-3 py-2.5 border border-zinc-500 rounded-lg text-sm font-medium hover:bg-gray-50 duration-150 active:bg-gray-100'
					>
						<svg
							className='w-5 h-5'
							viewBox='0 0 48 48'
