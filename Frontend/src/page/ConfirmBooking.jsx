...
//     imgUrl,
//   } = location.state || {};
//   console.log("singleRoomDetails : ", singleRoomDetails)
//   console.log(checkIn, checkOut, totalNights, price)
...
//         `${import.meta.env.VITE_SERVER_URL}/checkout/create-checkout-session`,
//         {
//           method: "POST",
//           headers: {
